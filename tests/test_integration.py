...
%%EOF"""
    ...
    def test_end_to_end_pdf_merge(self):
        ...
        try:
            ...
            self.assertGreater(os.path.getsize(output_file), 0, "Output file should not be empty")
    ...
    def test_end_to_end_excel_merge(self):
        ...
        self.assertGreater(len(merged_workbook.sheetnames), 0, "Output should have sheets")
    ...
    def test_performance_benchmarking(self):
        ...
        for i in range(5):  # Create 5 files
            try:
                ...
                # Add multiple pages
                for page in range(3):
                    c.drawString(100, 750, f"Performance test file {i}, page {page + 1}")
        ...
        self.assertTrue(os.path.exists(output_file), "Performance test output should exist")
