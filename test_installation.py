...
def create_sample_files():
    ...
    try:
        ...
        with open(info_file, 'w') as f:
            ...
            f.write("=====================\n\n")
            f.write("This directory contains sample files for testing the File Merger application.\n")
            f.write("To test with actual PDF or Excel files, add them to this directory.\n\n")
