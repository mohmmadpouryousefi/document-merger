...
def run_unit_tests(coverage=True, verbose=True):
    ...
    cmd = [
        ...
        "tests/test_excel_merger.py",
        "tests/test_file_merger.py",
    ]
...
"""
    ...
    return run_command([sys.executable, "-c", test_script], "Validating installation")
...
def main():
    ...
    parser.add_argument(
        "--dev-deps", action="store_true", help="Install development dependencies"
    )
    ...
    parser.add_argument(
        ...
        help=(
            "Run specific test "
            "(e.g., tests/test_pdf_merger.py::TestPDFMerger::test_merge_pdfs_success)"
        ),
    )
