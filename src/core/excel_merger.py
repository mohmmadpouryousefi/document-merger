...
class ExcelMerger:
    ...
    def merge_excel_files(self, input_files: List[str], output_file: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Successfully merged {len(input_files)} Excel files into {output_file}")
            return True
    ...
    def merge_specific_sheets(self, file_sheet_mapping: Dict[str, List[str]], output_file: str) -> bool:
        """
        ...
        try:
            ...
            for excel_file, sheet_names_to_copy in file_sheet_mapping.items():
                ...
                for sheet_name in sheet_names_to_copy:
                    if sheet_name in [sheet.title for sheet in source_workbook.worksheets]:
