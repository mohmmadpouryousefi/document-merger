...
class PDFMerger:
    ...
    def merge_pdfs(self, input_files: List[str], output_file: str) -> bool:
        ...
        try:
            ...
            merger.close()
            self.logger.info(f"Successfully merged {len(input_files)} PDFs into {output_file}")
            return True
    ...
    def merge_with_bookmarks(self, input_files: List[str], output_file: str) -> bool:
        ...
        try:
            ...
            merger.close()
            self.logger.info(f"Successfully merged {len(input_files)} PDFs with bookmarks")
            return True
